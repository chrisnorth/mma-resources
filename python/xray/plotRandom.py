...
models={
    '1':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '2':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '3':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '4':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '5':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '6':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '7':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '8':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
    '9':{'pars':{'jetType':grb.jet.Gaussian,'thetaObs':'thetarandom','d_L':'drandom'}},
}
...
fig.savefig(os.path.join(plotDir,"random_light_curves.png"))
# plt.close(fig)
plt.show()