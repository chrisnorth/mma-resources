(function(root){
	...
	var lang = {"default":"en","file":"languages.yml","languages":{"cy":{"enabled":"","inherit":"en","label":"Cymraeg","text":"Select your language (Welsh)"},"en":{"enabled":"","label":"English","text":"Select your language"},"en-US":{"enabled":"","inherit":"en","label":"English (US)","text":"Select your language (US)"}}};
	var code = "en";
